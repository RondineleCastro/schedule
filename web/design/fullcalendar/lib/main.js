            ...
            if (framePositions) {
                for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
                    ...
                    if (isAbsolute) {
                        ...
                        if (context.isRtl) {
                            right = 0;
                            // Rondinele:: correção de cálculo, pois estava calculando menos um dia no desenho da barra
                            left = framePositions.lefts[seg.lastCol] - framePositions.rights[seg.firstCol];
                            // left = framePositions.lefts[seg.lastCol] - framePositions.lefts[seg.firstCol];
                        }
                        else {
                            left = 0;
                            // Rondinele:: correção de cálculo, pois estava calculando menos um dia no desenho da barra
                            right = framePositions.lefts[seg.firstCol] - framePositions.rights[seg.lastCol];
                            // right = framePositions.rights[seg.firstCol] - framePositions.rights[seg.lastCol];

                            console.log('right: ' + right + ' lef1col: ' + framePositions.lefts[seg.firstCol] + ' rigLcol: ' + framePositions.rights[seg.lastCol]);
                        }
                    }
                    else {
